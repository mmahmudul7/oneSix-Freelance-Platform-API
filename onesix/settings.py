...
SECRET_KEY = 'django-insecure-6^u$&or%5jg2tdpvzpjinl6l34x2k!)ewbn!mnq^w+ix468fmr'
...
DJOSER = {
    ...
    'EMAIL_FRONTEND_SITE_NAME': 'OneSix',
...
DEFAULT_FROM_EMAIL = 'admin@onesix.dev'
